...
Important to note:
  ...
  Any strings can be used to name a state as long as they do not contain whitespace. It is possible to use the same character in the input and as a state
